...
import java.time.LocalTime;
 ...
 class Airplane {
  ...
  public void early(int minutes)
  {
    this.earlytime=minutes;
    this.scheduledDeparture=this.scheduledDeparture.minusMinutes(minutes);
  }
  ...
  public void checkStatus() {
    if (delayTime == 0) {
      System.out.println("Flight " + flightNumber + " is on time."+scheduledDeparture);
    } else {
      System.out.println("Flight " + flightNumber + " is delayed by " + delayTime + " minutes."+scheduledDeparture);
    }
  }
}
// Main.java
